...
export default class Prob27_2 extends Component {
  constructor(props) {
    super(props);
  ...
  submit() {
    ...
    dataService.getAns('27_3',this.state.answer).then(response=>{
      this.setState({
        link: response.data
      })
  ...
  render() {
    return (
      <div>
        <div className="story">
          <div className="marginbottom"> 3층에 도착했다.
        ...
        <div className="story">
          ...
          <br></br><br></br>5 Θ 3= 151
          <br></br><br></br>3 Θ 7= 210
          <br></br><br></br>9 Θ 2 = 711
          <br></br><br></br>6 Θ 4 = 210
          <br></br><br></br><br></br>7 Θ 1 = ?
        </div>        
        </div> 
        {((this.state.link === "/")?(
          ...
          <Link to={("/fsgEClI7MCvWpu6Binn8JSCPmfk3+4NkREgT4JSYtdMcGPZ8y33MefPDzuxyTExyb4VZMZt/DXw/jeJpZfc7lA==")} ><button className={'btn'}>이동</button></Link>
          </div>
        ))}
      </div>
    );
